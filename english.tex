...
Therefore it includes mora than one member.
...
\begin{center}
		...
		\textit{What is that \textbf{noise}?} (Even though \textit{nouse} can't be touched, you can hear it, so it's a concrete noun)
\end{center}
...
\begin{enumerate}[label=\alph*)]
		...
		\item Thingas you can touch and see\\
...
\end{tabular}
\end{center}
\caption{Common suffixes for abstract nouns} \label{tab:nouns4}
\end{table}
...
\begin{center}
\textit{My \textbf{brother's} computer was stolen a weej ago.\\
