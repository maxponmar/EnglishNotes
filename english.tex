...
We also use modals to ask permission, make requests and offers etc.\\
...
The modal verb \textbf{can} has only two forms:\\
\textit{can}(present) and \textit{could}(past). We use:
...
\begin{tabular}{|c|c|}
	...
	\textit{You \textbf{can't} somke here.} & \textit{He \textbf{couldn't} do it! He is such a sweet guy.} \\ \hline
...
\end{tabular}
\end{center}
\caption{Can and Could} \label{tab:cancould1}
\end{table}
...
\begin{enumerate}[label=(\alph*)]
	...
	\item To express our certainity in something being true. \\
...
We use \textbf{won't} whe someone refuses to do something.
