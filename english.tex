...
\begin{center}
	\textit{When she lived in China, Liz ate a lot of \textbf{Chinese} food.}
\end{center}
...
\begin{enumerate}[label=(\alph*)]
	...
	\item \textbf{Demonstrative adjectives} are adjectives that are used to modify a noun so that we know which specific person, place, or thing is mentioned. The most common demonstrative adjectives are \textbf{this, that, these, those.} \\
		e.g. \textit{\textbf{This} is July, and \textbf{that} girl over there is Judy.}
...
\begin{center}
	\textit{\textbf{Your} car is black.} (\textbf{Your} is an adjective which modifies the word 'car') \\
