...
\indent
This document was written for me to understand the English grammar from a beginner to an advanced level. Because I find that I can understand better if I take notes for myself while I'm watching English lessons, and I decided to make my notes with \LaTeX \hspace{0.05cm} beacause it is a useful and cool tool for writing awesome documents.\\
...
\begin{center}
	\textit{We were good grieds. \textst{We had been knowing each other for years.}\\
...
\subsubsection{Positive, negative and quiestion forms}
\begin{itemize}
	\item (+) At 6 o'clock I \textbf{will have been waiting} here for an hout. / At that time I\textbf{'ll have been waiting} here for an hour.
...
\begin{center}
	\textit{ \textbf{When} I complete my studies, I'll have been learing English for 17 years.}
\end{center}
