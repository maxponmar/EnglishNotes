...
\indent
This document was written to understand the English grammar from A1 to C2 levels. In order to let you to study on your schedule this document is divided in the main topics of English grammar, so that you can go directly to the topic that you want to learn.\\
\indent
...
\begin{center}
		\textst{I realley want to buy these cottons pants.}\\
